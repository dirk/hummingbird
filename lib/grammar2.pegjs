...
leftdecl = k:("let" / "var") whitespace n:name t:(":" whitespace type)? pos { return p.parseLeftDeclaration(k, n, t ? t[2] : null) }
...
multi = "multi" whitespace n:name _ a:args _ r:ret? { return p.parseMutli(n, a, r) }
...
funcexpr = "func" _ a:args _ rt:ret? _ wh:when? _ b:block { return p.parseFunction(a ? a : [], rt, wh, b) }
