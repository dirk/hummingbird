...
module.exports = function (p) {
  ...
  p.parseBlock = function (statements) {
    var block = new AST.Block(statements)
    block.setParsePosition(this)
    return block
  }
  ...
  p.parseFor = function (init, cond, after, block) {
    var f = new AST.For(init, cond, after, block)
    f.setParsePosition(this)
    return f
  }

  p.parseWhile = function (cond, block) {
    var w = new AST.While(cond, block)
    w.setParsePosition(this)
    return w
  }
