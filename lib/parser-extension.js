...
module.exports = function (p) {
  ...
  p.parseLeftDeclaration = function (decl, name, type) {
    var type = decl,
        Con  = (type === 'let') ? AST.Let : AST.Var,
        typepath = null
  ...
  p.parseAssignment = function (path, expr) {
    return new AST.Assignment('path', path, expr)
  }
