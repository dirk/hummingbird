...
TypeSystem.prototype.setupIntrinsics = function () {
  this.root.setLocal('String',  new types.String())
  this.root.setLocal('Number',  new types.Number())
  this.root.setLocal('Boolean', new types.Boolean())
  // Alias Integer to Number
  this.root.setLocal('Integer', new types.Number())
}
...
TypeSystem.prototype.visitStatement = function (node, scope, parentNode) {
  switch (node.constructor) {
    ...
    case AST.Multi:
      ...
      break
    case AST.Function:
      this.visitFunctionStatement(node, scope)
      break
    default:
...
TypeSystem.prototype.visitFunctionStatement = function (node, scope) {
...
TypeSystem.prototype.visitMulti = function (node, scope) {
  ...
  var multi = new types.Multi(args, ret)
  node.type = multi
