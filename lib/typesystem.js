...
Scope.prototype.get = function (name, fromNode) {
  if (this.locals[name] !== undefined) {
    return this.locals[name]
  } else if (this.parent !== null) {
    return this.parent.get(name, fromNode)
  } else {
    var node = (fromNode !== undefined) ? fromNode : null
    throw new TypeError('Unknown variable: '+name, node)
  }
}
