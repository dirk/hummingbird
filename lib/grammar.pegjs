{// Begin preamble
  ...
  p.parseIf = function (cond, block, elseBlock) { return [cond, block, elseBlock] }
...
ifctrl     = "if" _ c:innerstmt _ b:block e:(_ elsecont)? { return p.parseIf(c, b, e ? e[1] : null) }
elsecont   = "else" _ b:block { return b }
