...
block = pos "{" __ s:statements __ "}" { return p.parseBlock(s) }
...
whilectrl  = pos "while" _ c:innerstmt _ b:block { return p.parseWhile(c, b) }
forctrl    = pos "for" _ i:innerstmt? _ ";" _ c:innerstmt? _ ";" _ a:innerstmt? _ b:block { return p.parseFor(i, c, a, b) }
...
initdecl  = pos "init" _ a:args _ b:block  { return p.parseInit(a, b) }
...
binaryexpr = pos le:unaryexpr _ op:binaryop _ re:binaryexpr { return p.parseBinary(le, op, re) }
           / unaryexpr
