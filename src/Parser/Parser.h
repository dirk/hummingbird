...
/**
 ** \file /Users/dirk/Projects/hummingbird/hummingbird/src/Parser/Parser.h
...
#ifndef YY_YY_USERS_DIRK_PROJECTS_HUMMINGBIRD_HUMMINGBIRD_SRC_PARSER_PARSER_H_INCLUDED
# define YY_YY_USERS_DIRK_PROJECTS_HUMMINGBIRD_HUMMINGBIRD_SRC_PARSER_PARSER_H_INCLUDED
...
#endif
# if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<PNode*>&& v, location_type&& l);
#else
      basic_symbol (typename Base::kind_type t, const std::vector<PNode*>& v, const location_type& l);
#endif
    ...
    static
    symbol_type
    make_EOF_ (YY_COPY (location_type) l);

    static
    symbol_type
    make_ABSTRACT (YY_COPY (location_type) l);

    static
    symbol_type
    make_CLASS (YY_COPY (location_type) l);
    ...
    static
    symbol_type
    make_BRACE_LEFT (YY_COPY (location_type) l);

    static
    symbol_type
    make_BRACE_RIGHT (YY_COPY (location_type) l);
    ...
    static
    symbol_type
    make_LET (YY_COPY (location_type) l);

    static
    symbol_type
    make_LESS_THAN (YY_COPY (location_type) l);

    static
    symbol_type
    make_MIXIN (YY_COPY (location_type) l);

    static
    symbol_type
    make_PAREN_LEFT (YY_COPY (location_type) l);

    static
    symbol_type
    make_PAREN_RIGHT (YY_COPY (location_type) l);
    ...
    static
    symbol_type
    make_REAL (YY_COPY (location_type) l);
    ...
    static
    symbol_type
    make_STRING (YY_COPY (location_type) l);

    static
    symbol_type
    make_TERMINAL (YY_COPY (location_type) l);

    static
    symbol_type
    make_UNRECOGNIZED (YY_COPY (location_type) l);
...
# if 201103L <= YY_CPLUSPLUS
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, PNode*&& v, location_type&& l)
    : Base (t)
    , value (std::move (v))
    , location (std::move (l))
  {}
...
# if 201103L <= YY_CPLUSPLUS
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, std::vector<PNode*>&& v, location_type&& l)
    : Base (t)
    , value (std::move (v))
    , location (std::move (l))
  {}
#else
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::vector<PNode*>& v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  inline
  parser::symbol_type
  parser::make_EOF_ (YY_COPY (location_type) l)
  {
    return symbol_type (token::EOF_, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_ABSTRACT (YY_COPY (location_type) l)
  {
    return symbol_type (token::ABSTRACT, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_CLASS (YY_COPY (location_type) l)
  {
    return symbol_type (token::CLASS, YY_MOVE (l));
  }
  ...
  inline
  parser::symbol_type
  parser::make_BRACE_LEFT (YY_COPY (location_type) l)
  {
    return symbol_type (token::BRACE_LEFT, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_BRACE_RIGHT (YY_COPY (location_type) l)
  {
    return symbol_type (token::BRACE_RIGHT, YY_MOVE (l));
  }
  ...
  inline
  parser::symbol_type
  parser::make_LET (YY_COPY (location_type) l)
  {
    return symbol_type (token::LET, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_LESS_THAN (YY_COPY (location_type) l)
  {
    return symbol_type (token::LESS_THAN, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_MIXIN (YY_COPY (location_type) l)
  {
    return symbol_type (token::MIXIN, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_PAREN_LEFT (YY_COPY (location_type) l)
  {
    return symbol_type (token::PAREN_LEFT, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_PAREN_RIGHT (YY_COPY (location_type) l)
  {
    return symbol_type (token::PAREN_RIGHT, YY_MOVE (l));
  }
  ...
  inline
  parser::symbol_type
  parser::make_STRING (YY_COPY (location_type) l)
  {
    return symbol_type (token::STRING, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_TERMINAL (YY_COPY (location_type) l)
  {
    return symbol_type (token::TERMINAL, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_UNRECOGNIZED (YY_COPY (location_type) l)
  {
    return symbol_type (token::UNRECOGNIZED, YY_MOVE (l));
  }

  inline
  parser::symbol_type
  parser::make_VAR (YY_COPY (location_type) l)
  {
    return symbol_type (token::VAR, YY_MOVE (l));
  }
...
#endif // !YY_YY_USERS_DIRK_PROJECTS_HUMMINGBIRD_HUMMINGBIRD_SRC_PARSER_PARSER_H_INCLUDED
