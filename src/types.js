...
var inherits = require('util').inherits, inspect = require('util').inspect, TypeError = errors.TypeError;
...
var Type = (function () {
    ...
    Type.prototype.getTypeOfProperty = function (name, fromNode) {
        if (fromNode === void 0) { fromNode = null; }
...
var Function = (function (_super) {
    ...
    Function.prototype.argsMatch = function (otherArgs) {
        ...
        for (var i = args.length - 1; i >= 0; i--) {
            var arg = args[i], otherArg = otherArgs[i];
            matching[i] = arg.equals(otherArg);
        }
        if (!matching.every(isTrue)) {
            return false;
        }
        return true;
    };
    Function.prototype.inspect = function () {
        var ret = this.ret.inspect(), args = '';
